...
class Attendance_m extends CI_Model{
	...
	private $table_uc = 't_pegawai';
	private $table_uc_pk ='nomor_induk';
	...
	public function get_by_id($id_absen_susulan){
		$this->db->select('id_absen_susulan,'.$this->table_name.'.nomor_induk,id_atasan,tanggal_absen,t_alasan.id_alasan,nama_alasan,keterangan,approval_atasan,t_pegawai.kode_mesin');
		$this->db->from($this->table_name);
		$this->db->join('t_alasan','t_alasan.id_alasan = '.$this->table_name.'.id_alasan');
	...
	// 	SELECT id_absen_susulan,t_absen_susulan.nomor_induk,id_atasan,tanggal_absen,t_alasan.id_alasan,nama_alasan,keterangan,approval_atasan,t_pegawai.kode_mesin
	//  FROM t_absen_susulan
	//  JOIN t_pegawai ON t_absen_susulan.nomor_induk = t_pegawai.nomor_induk
	//  JOIN t_alasan ON t_absen_susulan.id_alasan = t_alasan.id_alasan
