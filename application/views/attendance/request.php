...
<div class="row">
	...
	<form class="form-horizontal" role="form" action="" method="POST">
		<div class="form-group">
			...
			<div class="col-md-2">
				<select class="form-control" name="nomor_induk_pegawai"s> <!-- id_pegawai sebagai acuan nama pegawai-->
				<?php 
		...
		<div class="form-group">
			<label class="col-sm-2 control-label" for="nomor_induk">Pilih Atasan</label>
		...
		<div class="form-group">
			<div class="col-sm-offset-1 col-sm-9">
				...
				<table class="table table-bordered" id="tabel_request">
					<thead>
						<tr>
							<th style="width:20%;text-align:center;padding:10px;">Tanggal Awal</th>
							<th style="width:20%;text-align:center;padding:10px;">Tanggal Akhir</th>
							<th style="width:30%;text-align:center;padding:10px;">Alasan</th>
							<th style="width:40%;text-align:center;padding:10px;">Keterangan</th>
							<th style="width:10%;text-align:center;padding:10px;">Langkah</th>
						</tr>
					</thead>
				</table>
			</div>
		...
		<div class="form-group">
			<div class="col-sm-offset-1 col-sm-9">
				Pilih tanggal dan alasan untuk mengajukan absen susulan
				<table>
					<tr>
						<td style="width:20%;text-align:center;padding:10px;">
							<input type="text" name="tanggal_request" id="tanggal_request" class="form-control date" placeholder="Masukkan Tanggal" maxlength="10">
						</td>
					</tr>
					<tr>
						<td style="width:20%;text-align:center;padding:10px;">
					...
					<tr>
						<td style="width:20%;text-align:center;padding:10px;">
							<input type="text" name="tanggal_requesta" id="tanggal_requesta" class="form-control date" placeholder="Masukkan Tanggal" maxlength="10">
						</td>
