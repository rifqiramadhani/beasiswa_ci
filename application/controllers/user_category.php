...
class User_category extends CI_Controller{
	...
	public function add(){
		$this->form_validation->set_rules('user_type_name','Nama Tipe Pengguna','required');
		...
		if($this->form_validation->run()==FALSE){
			...
			$this->session->set_flashdata('message_alert','<div class="alert alert-success">Data telah disimpan.</div>');
