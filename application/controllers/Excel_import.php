...
class Excel_import extends CI_Controller {
	...
	public function do_upload()
    {
        ...
        else
        {
				...
				//$this->session->set_flashdata('message_alert','<div class="alert alert-danger">Data berhasil diunggah</div>');
				$this->session->set_flashdata('message_alert','<div class="alert alert-success">Data berhasil diunggah</div>');
        		...
        		if(file_exists($file_check)){
        			//print_r("sudah ada --- ");
        			$this->session->set_flashdata('message_alert','<div class="alert alert-danger">Data sudah tesedia</div>');
        			...
        			else
        			{
        				...
        				$this->session->set_flashdata('message_alert','<div class="alert alert-danger">Data gagal dipindah</div>');
						redirect('Excel_import');
        			}
        		}
        		// redirect('presences/upload_data_view');
        		$this->template->display('presences/upload_data_view');
