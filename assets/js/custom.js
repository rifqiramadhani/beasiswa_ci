$(document).ready(function(){
	...
	// $('#tanggal_lhr_peserta').datetimepicker({
	// 	pickTime: false
	// });
	...
	$('#generate_plan').click(function(){
		...
		// if(tahun_plan % 4 == 0){
		// 	var bulan_days = [31,29,31,30,31,30,31,31,30,31,30,31];
		// }
		// else
		// {
		...
		if(bulan_plan==''){
			...
			alert('Mohon pilih tahun yang sesuai.');
			$('#tahun_plan').focus();
		}else{

			//check bulan yang bisa di pilih
			$.ajax({
...
;
	...
	$('#add_alasan_request').click(function(){
		...
		if($('#tanggal_request').val()==''){
			...
			alert('Pilih Alasan Absen Susulan ');
			...
			html_add += '<td><input type="text" name="send_tanggal_requesta[]" class="form-control" id="send_tanggal_requesta_'+counter+'" value="'+$('#tanggal_requesta').val()+'" readonly="true"></td>';
			html_add += '<td><input type="hidden" name="send_id_alasan_request[]" id="send_id_alasan_request_'+counter+'" value="'+$('#alasan_request').val()+'"><input type="text" name="send_alasan_request[]" class="form-control" id="send_alasan_request_'+counter+'" value="'+$('#alasan_request option:selected').text()+'" readonly="true"></td>';
